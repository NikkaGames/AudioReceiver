...
extern "C"
JNIEXPORT jint JNICALL Java_ge_nikka_audioreceiver_Opus_encoderInit(JNIEnv *env, jobject thiz, jint sample_rate, jint num_channels, jint application) {
    return codec.encoderInit(sample_rate, num_channels, application);
}

extern "C"
JNIEXPORT jint JNICALL
Java_ge_nikka_audioreceiver_Opus_encoderSetBitrate(JNIEnv *env, jobject thiz, jint bitrate) {
    return codec.encoderSetBitrate(bitrate);
}

extern "C"
JNIEXPORT jint JNICALL
Java_ge_nikka_audioreceiver_Opus_encoderSetComplexity(JNIEnv *env, jobject thiz, jint complexity) {
    return codec.encoderSetComplexity(complexity);
}

extern "C"
JNIEXPORT jbyteArray JNICALL
Java_ge_nikka_audioreceiver_Opus_encode___3BI(JNIEnv *env, jobject thiz, jbyteArray bytes, jint frame_size) {
...
Java_ge_nikka_audioreceiver_Opus_encode___3SI(JNIEnv *env, jobject thiz, jshortArray shorts, jint frame_size) {
...
Java_ge_nikka_audioreceiver_Opus_encoderRelease(JNIEnv *env, jobject thiz) {
    codec.encoderRelease();
}

extern "C"
JNIEXPORT jint JNICALL
Java_ge_nikka_audioreceiver_Opus_decoderInit(JNIEnv *env, jobject thiz, jint sample_rate, jint num_channels) {
    return codec.decoderInit(sample_rate, num_channels);
}

extern "C"
JNIEXPORT jbyteArray JNICALL
Java_ge_nikka_audioreceiver_Opus_decode___3BII(JNIEnv *env, jobject thiz, jbyteArray bytes, jint frame_size, jint fec) {
    jbyte *nativeBytes = env->GetByteArrayElements(bytes, 0);
...
extern "C"
JNIEXPORT jshortArray JNICALL
Java_ge_nikka_audioreceiver_Opus_decode___3SII(JNIEnv *env, jobject thiz, jshortArray shorts, jint frame_size, jint fec) {
    jshort *nativeShorts = env->GetShortArrayElements(shorts, 0);
    jint length = env->GetArrayLength(shorts);
...
extern "C"
JNIEXPORT void JNICALL
Java_ge_nikka_audioreceiver_Opus_decoderRelease(JNIEnv *env, jobject thiz) {
    codec.decoderRelease();
}

extern "C"
JNIEXPORT jshortArray JNICALL
Java_ge_nikka_audioreceiver_Opus_convert___3B(JNIEnv *env, jobject thiz, jbyteArray bytes) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_ge_nikka_audioreceiver_Opus_convert___3S(JNIEnv *env, jobject thiz, jshortArray shorts) {
